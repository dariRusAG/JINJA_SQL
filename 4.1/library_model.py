# Модель (программа) - для реализации функций обращения к базе данных:
# создаются функции, в которых выполняются запросы к базе данных
# и возвращается результат выборки.
